...
##COMMAND LINE INPUT SECTION########################################################################################################
    ...
    if len(argv) < 6:
        ...
        print ( "Usage: ./names3to4 names3to4.py -f <input file name> -y <input file year> -s <input file sex>" )
        sys.exit(2)
    ...
    try:
        ...
        print ("Usage: ./names3to4.py -f <input file name> -y <input file year> -s <input file sex>")
        sys.exit(2)
...
#            print(year)
            ...
            people = {'Name':name,'Year':year,'Count':count, 'Sex': sex}
...
##            print ("The top 5 names in " + str(year) +" are")
##            for i in range(10):
##                print (str(rankedPeople_df.iloc[i]['Rank']) +"\t"+ str(rankedPeople_df.iloc[i]['Number'])+"\t"+ str(rankedPeople_df.iloc[i]['Name']))
